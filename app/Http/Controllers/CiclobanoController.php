...
class CiclobanoController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
       ...
       $total = number_format($total,1,'.',',');
        ...
        return view('ciclobano.edit',compact('total','ciclosos','date1','date2','date3','date4','date5','date6','date7','date8','date9','date10','date11','date12','date13','date14','date15','date16','date19','date20','date21','date22','ciclosos','hoy','hora','llave','user_nombre','user_cedula','timebreak','timelunch','timecapa','timepausas','timedaño','timeeva', 'timeretro','timereunion','timeEmeMedica','timebano'));
