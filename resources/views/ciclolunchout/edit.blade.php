                    ...
                    <div class="card-bodyNew style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                @if ($timebreak > 20)
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Tiempo de Break</b><rem2 class="tiemp-text">{{ $timebreak }}</rem2><b> minutos</b></small></p>
                                @else
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Tiempo de Break</b><rem class="tiemp-text"> {{ $timebreak }}</rem><b> minutos</b></small></p>
                                @endif
                    ...
                    <div class="card-bodyNew style_card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Tiempo de Pausas Activas: </b><rem class="tiemp-text">0</rem> </small></p>
                                @else
                                <p class="card-text reloj-text"><small class="text-muted2"><b>Tiempo de Pausas Activas: </b><rem class="tiemp-text">  {{ $timepausas }}</rem> </small></p>
                                @endif
                        </div>
                    </div>
                </div>
